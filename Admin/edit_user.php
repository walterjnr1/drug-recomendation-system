            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <select id="cmdrole" name="cmdrole" class="form-control">
                        ...
                        <option value="Doctor" <?php echo $_POST['cmdrole'] == 'Doctor' ? 'selected' : ''; ?>>Doctor</option>
                         <option value="Pharmacist" <?php echo $_POST['cmdrole'] == 'Pharmacist' ? 'selected' : ''; ?>>Pharmacist</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
